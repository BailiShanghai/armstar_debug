...
__attribute__((packed, aligned(4)))  unsigned char aes_test_ecb_enc[16] __attribute__((section("aes_sec"))) = {
        0xC3,0x4C,0x05,0x2C,0xC0,0xDA,0x8D,0x73,0x45,0x1A,0xFE,0x5F,0x03,0xBE,0x29,0x7F
};

__attribute__((packed, aligned(4)))  unsigned char aes_test_ecb_key[16] __attribute__((section("aes_sec"))) = {
        0x2B,0x7E,0x15,0x16,0x28,0xAE,0xD2,0xA6,0xAB,0xF7,0x15,0x88,0x09,0xCF,0x4F,0x3C
};

__attribute__((packed, aligned(4)))  unsigned char aes_test_ecb_dec[16] __attribute__((section("aes_sec"))) = {
