...
void non_secure_world_access_s_shared_memory(void)
{
	mem_access_test(SECURE_SHAREDM_START_ADDR, VERIFY_DATA_LEN);
}

void non_secure_world_access_ns_shared_memory(void)
{
...
{
	non_secure_world_access_ns_shared_memory();
	non_secure_world_access_s_shared_memory();
}
// eof
