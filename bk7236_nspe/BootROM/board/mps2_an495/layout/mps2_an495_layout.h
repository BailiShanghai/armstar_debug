...
#ifndef __MPS2_AN495_LAYOUT_H__
#define __MPS2_AN495_LAYOUT_H__
 ...
 * mps2_an521_layout_symmetric.h
 */

/*
 * Internal definations, don't use them
 */
#define __LAYOUT_FLASH_BASE_BLOCK_SIZE  (0x00040000)
#define __LAYOUT_ROM_BASE_BLOCK_SIZE    (__LAYOUT_FLASH_BASE_BLOCK_SIZE)

/*
 * Defines the SoC memory map
 */
#define LAYOUT_ROM_NS_BASE          (0x00000000)
#define LAYOUT_ROM_S_BASE           (0x10000000)
#define LAYOUT_TOTAL_ROM_SIZE       (0x00400000)
...
#define LAYOUT_RAM_NS_BASE          (0x20000000)
#define LAYOUT_RAM_S_BASE           (0x30000000)
#define LAYOUT_TOTAL_RAM_SIZE       (0x00200000)
#define LAYOUT_RAM_SIZE_S           (LAYOUT_TOTAL_RAM_SIZE / 2)
#define LAYOUT_RAM_SIZE_NS          (LAYOUT_TOTAL_RAM_SIZE / 2)

#define LAYOUT_SPI_FLASH_START      (0x0E000000)
...
/* primary manifest */
#define LAYOUT_PRIM_MANIFEST_FLASH_OFFSET   (0x003C0000)
...
/* recovery manifest */
#define LAYOUT_RECV_MANIFEST_FLASH_OFFSET   (0x00440000)
...
/* control partition */
#define LAYOUT_CTRL_PARTITION_FLASH_OFFSET  (0x00500000)
...
/* the simulated OTP */
#define LAYOUT_SIMU_OTP_FLASH_OFFSET        (0x00A40000)
